...
_lr_productions = [
  ...
  ('statement -> FLOATDEC NAME','statement',2,'p_statement_declare_float','compiler.py',76),
  ('statement -> PRINT ( expression )','statement',4,'p_statement_print','compiler.py',80),
  ('statement -> NAME = expression','statement',3,'p_statement_assign','compiler.py',84),
  ('statement -> expression','statement',1,'p_statement_expr','compiler.py',91),
  ...
  ('expression -> - expression','expression',2,'p_expression_uminus','compiler.py',107),
  ('expression -> ( expression )','expression',3,'p_expression_group','compiler.py',112),
  ('expression -> INUMBER','expression',1,'p_expression_inumber','compiler.py',117),
  ('expression -> FNUMBER','expression',1,'p_expression_fnumber','compiler.py',122),
  ('expression -> NAME','expression',1,'p_expression_name','compiler.py',127),
]
